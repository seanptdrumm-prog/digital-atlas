# === Atlas 9: Partner-Facing COB Matcher ===
...
st.markdown("<h2 style='text-align:center;color:#fff;'>Atlas 9: Hiscox Digital Atlas</h2>", unsafe_allow_html=True)
st.markdown("<hr style='border-top:2px solid #d7263d;'>", unsafe_allow_html=True)

# === SECTION: Search (Top Match Only) ===
...
if uploaded_file:
    ...
    if "Partner_Description" not in df.columns:
        ...
        st.download_button("⬇️ Download CSV", result_df.to_csv(index=False).encode("utf-8"), "atlas9_results.csv", "text/csv")