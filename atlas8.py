...
# === UI ===
st.markdown("<h2 style='text-align:center;color:#fff;'>Atlas 8: Hiscox COB Matcher</h2>", unsafe_allow_html=True)
...
if uploaded_file:
    ...
    if "Partner_Description" not in df.columns:
        ...
        st.download_button("⬇️ Download CSV", result_df.to_csv(index=False).encode("utf-8"), "atlas8_results.csv", "text/csv")
