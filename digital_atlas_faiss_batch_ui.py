...
# === HEADER ===
st.markdown("<h2 style='text-align:center;color:#fff;'>Hiscox Digital Atlas (FAISS + Batching)</h2>", unsafe_allow_html=True)
...
if uploaded_file:
    ...
    if "NAICS_Description" not in df.columns:
        ...
        st.success("Running vector-based FAISS matching in batches ⚡")
        ...
        st.download_button(
            ...
            file_name="Digital_Atlas_Batch_FAISS_Report.csv",
            mime="text/csv"
        )
