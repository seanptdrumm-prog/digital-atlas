...
# === Header ===
st.markdown("<h2 style='text-align:center;color:#fff;'>Atlas: NAICS + COB Scoring Engine</h2>", unsafe_allow_html=True)
...
def compute_score(input_text, match_row, similarity_score):
    ...
    if "appraisal" in input_clean or "appraiser" in input_clean:
        score -= 0.5
        sources.append("Appraisal Service Penalty (General Exclusion)")
